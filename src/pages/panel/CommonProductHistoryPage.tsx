...
export default function CommonProductHistoryPage() {
    return (
        <div>
            ...
            <h3 className='mt-3 mt-lg-5 mb-3'>Riwayat Generate label Produk</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className='d-flex justify-content-center align-items-center'>
                                                <Link to={'/panel/common-product-history-detail'} className="btn btn-sm btn-success mr-2"><Detail className="mr-1" /> Lihat</Link>
